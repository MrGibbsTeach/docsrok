...
const PLANS = [
  {
    ...
    name: 'Core',
    price: '$89',
    description: 'For sole traders and small construction businesses.',
    features: [
      '1 business profile',
      'WHS Policy',
      'Hazard Register',
      ...
      'SWMS for up to 10 work activities',
      'QLD + NSW legislation',
      'Email support',
    ],
    highlight: false,
  ...
  },
  {
    ...
    name: 'Team',
    price: '$249',
    description: 'For contractors managing multiple business entities.',
    features: [
      'Everything in Plus',
      'Up to 5 business profiles',
      'Centralised document dashboard',
      'Bulk document regeneration',
      'Phone support',
    ],
    highlight: false,
  },
