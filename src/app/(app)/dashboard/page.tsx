...
import { DOCUMENT_LABELS, WORK_ACTIVITIES, type DocumentType } from '@/lib/types'
...
export default async function DashboardPage({
  ...
  return (
    <div className="space-y-6">
        ...
        {documents && documents.length > 0 ? (
                ...
                <div className="min-w-0">
                  ...
                  <div className="text-xs text-gray-400 mt-1 flex items-center gap-3">
                    ...
                    <GenerateDocButton
                      ...
                      docType={doc.activity_key ? undefined : doc.type}
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-12 text-center">
            ...
            <p className="text-sm text-gray-500 mb-6">
              Your WHS Policy, SWMS, Hazard Register, and other compliance documents are being
      ...
      {/* SWMS Library — all 10 activities */}
      {documents && documents.length > 0 && (
        <div>
          <h2 className="text-base font-semibold text-gray-900 mb-1">SWMS library</h2>
          <p className="text-xs text-gray-500 mb-4">
            Generate a Safe Work Method Statement for any high-risk construction activity.
          </p>
          <div className="grid gap-2">
            {WORK_ACTIVITIES.map((activity) => {
              const existingDoc = documents.find(
                (d) => d.type === 'swms' && d.activity_key === activity.key
              )
              return (
                <div
                  key={activity.key}
                ...
                >
                  <div className="min-w-0">
                    <div className="text-sm text-gray-800">{activity.label}</div>
                    {existingDoc && (
